...
LIST_PROVIDER_UPDATE_FREQUENCY = _config.get("list_provider_update_frequency", 120)
WATCHER_SPAWN_WAIT_TIME_IN_SEC = _config.get("watcher_spawn_wait_time_in_sec", 5)
...
SQS_BATCH_SIZE = int_env("SQS_BATCH_SIZE", _SQS_BATCH_SIZE_DEFAULT)
