# -*- coding: utf-8 -*-
#
# omnibot documentation build configuration file
#
...
extlinks = {
    'repo': ('https://github.com/lyft/omnibot/blob/{}/%s'.format(blob_sha), ''),
    'api': ('https://github.com/lyft/omnibot/blob/{}/api/%s'.format(blob_sha), ''),
}
...
project = u'omnibot'
copyright = u'2019-{}, Omnibot Project Authors'.format(datetime.now().year)
author = u'Omnibot Project Authors'
...
release = os.environ['OMNIBOT_DOCS_VERSION_STRING']
